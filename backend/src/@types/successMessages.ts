interface ISuccessMessages {
    ...
    loggedOutMessage: 'Thank you for visiting Rolling Records, welcome back again!';
    ...
    passwordRecoveryPincodeSentMessage: 'Password recovery pincode was sent to your email or mobile number.';
...
export default ISuccessMessages;
